...
<body id="bodyPantallaInicial">
    ...
    <div class="aligncon" id="contentPantallaInicial">
        <div class="container-fluid text-center justify-content-center">
            <h1 id="tituloInicial">GESTIÓN DE INFORMES</h1>
            <p>Est. 2122 | MU-TH-UR 6000 | Propiedad de WEYLAND-YUTANI CORP</p>
    ...
    <!-- INCLUDES (ya que la ruta del mp3 es distinto en este archivo el include da error) -->
